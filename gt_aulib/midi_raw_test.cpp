...
TEST(midi_raw_tests, ValidateMThdChunkTests) {
	...
	std::vector<tests> all_tests {
		...
		// Invalid:  Invalid smpte time-code in tile-division field
		{{0x4D,0x54,0x68,0x64,0x00,0x00,0x00,0x06,0x00,0x01,0x00,0x03,0xFF,0xFF},100,
			false,14,mthd_validation_error::invalid_time_division_field},
	};
