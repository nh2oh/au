...
TEST(midi_raw_tests, midiInterpretVLFieldTests) {
	...
	std::vector<tests_t> p131_tests {
		...
		{{0x00,0x00,0x00,0x00,0x00,0x00},{0x00000000,1,true}},
		{{0x40,0x00,0x00,0x00,0x00,0x00},{0x00000040,1,true}},
		{{0x00,0x00,0x00,0x40,0x00,0x00},{0x00000000,1,true}},
		{{0x7F,0x00,0x00,0x00,0x00,0x00},{0x0000007F,1,true}},
		{{0x00,0x00,0x00,0x7F,0x00,0x00},{0x00000000,1,true}},

		{{0x71,0x00,0x00,0x00,0x00,0x00},{0x00000071,1,true}},
		{{0x70,0x00,0x00,0x00,0x00,0x00},{0x00000070,1,true}},
		{{0x0F,0x7F,0x00,0x00,0x00,0x00},{0x00000F7F,2,true}},
		{{0x7F,0xFF,0x00,0x00,0x00,0x00},{0x00007F7F,2,true}},

		{{0x71,0x80,0x00,0x00,0x00,0x00},{0x00000071,1,true}},
		{{0x81,0x80,0x00,0x00,0x00,0x00},{0x00010000,3,true}},
		{{0xC0,0x80,0x00,0x00,0x00,0x00},{0x00400000,3,true}},
		{{0x3F,0xFF,0x7F,0x00,0x00,0x00},{0x0000003F,1,true}},
		{{0x7F,0xFF,0x3F,0x00,0x00,0x00},{0x0000007F,1,true}},

		{{0x80,0x80,0x80,0x00,0x00,0x00},{0x00000000,4,true}},
		{{0x80,0x80,0x80,0x01,0x00,0x00},{0x00000001,4,true}},
		{{0xC0,0x80,0x01,0x00,0x00,0x00},{0x00400001,3,true}},
		{{0xFF,0xFF,0xFF,0x00,0x00,0x00},{0x7F7F7F00,4,true}},
		{{0xFF,0xFF,0xFF,0x7F,0x00,0x00},{0x7F7F7F7F,4,true}},
