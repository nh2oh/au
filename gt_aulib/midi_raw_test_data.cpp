...
std::vector<delta_time_test_data_t> dt_test_set_a {
	{0x00u, 1, 0x00u},
	{0x40u, 1, 0x40u},
	{0x7Fu, 1, 0x7Fu},
	{0x80u, 2, 0x80u},
	...
	{0x3FFFu, 2, 0x3FFFu},
	{0x4000u, 3, 0x4000u},
	{0x100000u, 3, 0x100000u},
	{0x1FFFFFu, 3, 0x1FFFFFu},
	{0x00200000u, 4, 0x00200000u},
	{0x08000000u, 4, 0x08000000u},
	{0x0FFFFFFFu, 4, 0x0FFFFFFFu},
	{0x1FFFFFFFu, 4, 0x0FFFFFFFu},
	{0x2FFFFFFFu, 4, 0x0FFFFFFFu},
	{0x7FFFFFFFu, 4, 0x0FFFFFFFu},
	{0x8FFFFFFFu, 4, 0x0FFFFFFFu},
...
// "dbs" == "data bytes"
//
std::vector<unsigned char> sbs_invalid {
	0x00u,0x01u,0x02u,0x0Au,0x0Bu,0x0Fu,
};
std::vector<unsigned char> sbs_meta_sysex {0xFFu,0xF0u,0xF7u};
std::vector<unsigned char> sbs_unrecognized {0xF1u,0xF2u,0xF8u,0xFAu};
std::vector<unsigned char> sbs_ch_mode_voice {
...
std::vector<unsigned char> dbs_valid {
	0x00u,0x01u,0x02u,0x0Au,0x0Bu,0x0Fu,
};
std::vector<unsigned char> dbs_invalid {
