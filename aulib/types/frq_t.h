...
// v = fmax(v, 0.0). So, 
//
// frq_t myfrq {-23.123, frq_t::unit::Hz};
// is interpreted as: 
// frq_t myfrq {23.123, frq_t::unit::Hz};
//
...
// constructed like: 
// frq_t myfrq {100, frq_t::unit::kHz};
...
// value of a frq_t can be extracted with operator/(frq_t).  To convert some 
// frq_t object myfrq to, for example, a "number of kHz:"  
// 
// auto number_of_kHz = myfrq/frq_t{1,frq_t::units::kHz};
//
